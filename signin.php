  ...
  <section class="pt-100 login-register">
    <div class="container"> 
      <div class="row login-register-cover">
        ...
        <div class="img-1 d-none d-lg-block"><img class="shape-1" src="dist/images/login/img-4.svg" alt="jobnest"></div>
        <div class="img-2"><img src="dist/images/login/img-3.svg" alt="jobnest"></div>
      </div>
    </div>
  </section>
</main>
