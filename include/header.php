      ...
      <div class="container">
        <div class="main-header">
          ...
          <div class="header-right">
            <div class="block-signin"><a class='text-link-bd-btom hover-up' href='page-register.html'>Register</a><a class='btn btn-default btn-shadow ml-40 hover-up' href='signin.php'>Sign in</a></div>
          </div>
        </div>
      </div>
    </header>
